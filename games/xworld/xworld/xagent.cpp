...
std::string XAgent::speak(const std::string& command) { return command; }

std::string XAgent::listen(const std::string& command) { return command; }

void XAgent::update_location(int x, int y) { this->set_item_location(x, y); }
...
void XAgent::register_actions() {
    ...
    //    action_callbacks_.push_back(std::bind(&XAgent::move_up_two_steps,
    //    this));
    //    action_callbacks_.push_back(std::bind(&XAgent::move_down_two_steps,
    //    this));
    //    action_callbacks_.push_back(std::bind(&XAgent::move_left_two_steps,
    //    this));
    //    action_callbacks_.push_back(std::bind(&XAgent::move_right_two_steps,
    //    this));
}
...
bool XAgent::move_up_two_steps() { return move_up() && move_up(); }

bool XAgent::move_down_two_steps() { return move_down() && move_down(); }

bool XAgent::move_left_two_steps() { return move_left() && move_left(); }

bool XAgent::move_right_two_steps() { return move_right() && move_right(); }

bool XAgent::act(int action_id) { return action_callbacks_[action_id](); }
}
