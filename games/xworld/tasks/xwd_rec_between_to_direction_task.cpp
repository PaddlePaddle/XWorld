...
std::string XWorldRecBetweenToDirectionTask::idle(ScannerPtr scanner,
                                                  SentenceTemplatePtr sen_temp,
                                                  TeachingEnvPtr game) {
...
void XWorldRecBetweenToDirectionTask::define_sen_temp_rules(
...
std::vector<std::vector<Entity>> XWorldRecBetweenToDirectionTask::find_goal(
    ScannerPtr scanner) {
