...
std::string XWorldRecBetweenToObjectTask::idle(ScannerPtr scanner, SentenceTemplatePtr sen_temp,
                                             TeachingEnvPtr game) {
...
void XWorldRecBetweenToObjectTask::define_sen_temp_rules(SentenceTemplatePtr sen_temp, TeachingEnvPtr game) {
...
std::vector<std::vector<Entity>> XWorldRecBetweenToObjectTask::find_goal(ScannerPtr scanner) {

    std::vector<std::vector<Entity>> goal_sets;
    std::vector<Entity> middle;
    std::vector<Entity> west_goals;
    std::vector<Entity> east_goals;
    between_two_goals(middle, west_goals, east_goals, scanner,
