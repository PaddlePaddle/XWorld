...
std::string XWorldRecObjectToDirectionTask::idle(ScannerPtr scanner,
                                                 SentenceTemplatePtr sen_temp,
                                                 TeachingEnvPtr game) {
...
void XWorldRecObjectToDirectionTask::define_sen_temp_rules(
...
std::vector<std::vector<Entity>> XWorldRecObjectToDirectionTask::find_goal(
    ScannerPtr scanner) {
