...
'''
Task: Move small crate back to the room which agent has been populated.

This task requires agent to explore the world and collect the keys
to unlock the matching doors. And finally, find the small crate and
move back to the room which agent has been populated.
'''
